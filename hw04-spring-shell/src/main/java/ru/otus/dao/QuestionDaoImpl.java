...
public class QuestionDaoImpl implements QuestionDao {
    ...
    public String getMessage(String message) {
        ...
        String welcome = messageSource.getMessage("welcome", null, properties.getLocale());
        String insertNameAndFirstname = messageSource.getMessage("insertNameAndFirstname", null, properties.getLocale());
        ...
        messages.put("insertNameAndFirstname", insertNameAndFirstname);
